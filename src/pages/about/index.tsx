  ...
  return (
    <Container>
      ...
      <div className="relative">
        ...
        <div className="absolute right-0 -top-[30vh]">
          <RedDotTwo />
        </div>

        <div className="w-[90vw] mt-[20vh] mx-auto border border-[#ccc] items-center rounded-2xl p-10 flex justify-between">
          <div className="w-[55%]">
      ...
      <div className="relative">
        ...
        <div className="w-[90vw] mt-[10vh] mx-auto border border-[#ccc] items-center rounded-2xl p-10 flex justify-between">
          ...
          <div className="w-[40%] flex relative">
            ...
            <img
              ...
              alt="Image"
              className="right-0 object-cover absolute bottom-0 h-[377px] w-[301px]"
            />
          </div>
        </div>
      </div>
      ...
      <div className="w-[90vw] mt-[10vh] mb-20 mx-auto bg-[#fff] text-[#333] items-center rounded-2xl p-10 flex justify-between">
        <div className="w-[55%] z-10">
          <div className="space-y-4">
            <h2 className="text-[42px] font-semibold">Our mission</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-[42px] font-semibold mt-10">Our vision</h2>
            <p className="text-[24px] mt-4">
        ...
        <div className="w-[40%] flex relative">
          ...
          <img
            ...
            alt="Image"
            className="right-0 object-cover absolute bottom-14 h-[377px] w-[301px]"
          />
        </div>
      </div>
      <Footer />
